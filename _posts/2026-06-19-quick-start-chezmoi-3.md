...
Original source: [Original post](<https://www.chezmoi.io/quick-start/>)
...
`git remote add origin git@github.com:$GITHUB_USERNAME/dotfiles.git git branch -M main git push -u origin main`
